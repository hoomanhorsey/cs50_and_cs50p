...
# Version
# Register route is completed, but does not account for hashes. Just uses pure passwords. Needs to be updated to include hashes.
...
def register():
    ...
    if request.method == "POST":
       ...
       # Password confirmation must match password
        ...
        # If username already exists ##TO DO
        ...
        # Insert user and password into values #TODO PASSWORD IS NOT HASHED!!!
