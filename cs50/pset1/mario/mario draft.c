...

{
    ...
    // Note:(r)ow begins at 1, not 0 as per convention.  This is to ensure that later, Loop B1 doesn't print anything....as it need to be blank.  I tried recoding to make it start at 0, and changing the Loops, but coudn't get it to work.
    // h = height, r = row
